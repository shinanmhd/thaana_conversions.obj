...
class Converter
{
    ...
    public function convertUtf8ToAscii($text)
    {
        ...
        return strrev($this->reverseNumerics($text));
    }
     ...
     * @access private
     */
    private function getAsciiChar(string $key): string
    {
     ...
     * @access private
     */
    private function getUtf8Char(int $code): string
    {
     ...
     * @access private
     */
    private function reverseNumerics(string $text): string
    {
